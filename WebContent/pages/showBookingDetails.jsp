...
<form>
		...
		<c:forEach items="${moviebookingList}" var="bookingList">
			<tr>
				<td>${bookingList.bookingId}</td>
				<td>${bookingList.theaterName}</td>
				<td>${bookingList.movieName}</td>
				<td>${bookingList.noOfTickets}</td>
				<td>${bookingList.ticketCost}</td>
				<td>${bookingList.totalPrice}</td>
				<td>${bookingList.bookingDate}</td>
				<td>${bookingList.assignedDate}</td>
				<td>${id}</td>
				
			</tr>
		</c:forEach>
		</table>
		<a href="MovieController?action=viewTicketPage">Back</a>
	</form>
	</div>
</body>
</html>